 ...
 */
public class RabbitmqMessageConstants {

    public static final String RABBITMQ_PLUGIN_PROPERTY_PREFIX = "plugin.rabbitmq";
    public static final String MPC = "mpc";
    public static final String MESSAGE_ID = "messageId";
    public static final String P1_IN_BODY = "p1InBody";
    public static final String RABBITMQ_BACKEND_MESSAGE_TYPE_PROPERTY_KEY = "messageType";
    ...
    public static final String RABBITMQ_PAYLOAD_NAME_FORMAT = PAYLOAD_NAME_FORMAT + "_" + MessageConstants.PAYLOAD_PROPERTY_FILE_NAME;
